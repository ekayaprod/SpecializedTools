...
BOUNDARIES
✅ Always do:
- Target *measurable* wins (re-renders, N+1 queries, large images)
- Add comments explaining *why* this improves speed
...
2. 🎯 SELECT: Plan a fix that also improves the UI state (Palette+).
   *NOTE:* If interactions are already fast and smooth, STOP.
