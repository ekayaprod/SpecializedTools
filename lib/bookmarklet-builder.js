(function(root) {
    ...
    /**
     * Extracts dependencies from source code via @require directives in block comments.
     * Note: Line comments (//) are ignored by the parser.
     *
     * @param {string} code - The source code to parse.
     * @returns {string[]} An array of required filenames.
     *
     * @example
     * const source = "/* @require utils.js *" + "/";
     * const deps = BookmarkletBuilder.extractDependencies(source);
