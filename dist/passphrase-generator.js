...
structSel.onchange = (e) => { STATE.config.structure =  (e.target).value; render(); };
...
minInp.onchange = (e) => { STATE.config.minLength = parseInt( (e.target).value); render(); };
...
maxInp.onchange = (e) => { STATE.config.maxLength = parseInt( (e.target).value); render(); };
...
padChk.onchange = (e) => { STATE.config.padToMin =  (e.target).checked; render(); };
...
numSel.onchange = (e) => { STATE.config.numPlacement =  (e.target).value; render(); };
...
symSel.onchange = (e) => { STATE.config.symPlacement =  (e.target).value; render(); };
...
countInp.onchange = (e) => { STATE.tempConfig.count = parseInt( (e.target).value); render(); };
