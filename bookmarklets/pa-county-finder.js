...
(function () {
    ...
    if (!document.getElementById(styleId)) {
        ...
        style.textContent = `
            ...
            .pa-card { background: white; padding: 24px; border-radius: 16px; box-shadow: 0 20px 50px rgba(0,0,0,0.3); width: 320px; font-family: system-ui, -apple-system, sans-serif; animation: pa-slide-up 0.3s cubic-bezier(0.16, 1, 0.3, 1); max-width: 90vw; display: flex; flex-direction: column; gap: 12px; }
            ...
            .pa-btn:focus-visible { outline: none; box-shadow: 0 0 0 2px white, 0 0 0 4px var(--pa-primary); }
            ...
            .pa-input:focus-visible { outline: none; box-shadow: 0 0 0 2px rgba(37,99,235,0.4); }
            ...
            .pa-copy-btn { background: white; border: 1px solid var(--pa-border); border-radius: 6px; padding: 6px; cursor: pointer; color: var(--pa-copy-text); transition: all 0.3s ease-in-out; min-width: 44px; min-height: 44px; display: flex; align-items: center; justify-content: center; }
