...
(function () {
    ...
    class WebClipper {
        ...
        showLoadingOverlay(message) {
            ...
            const spinner = `
                <svg width="40" height="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true">
            ...
            div.innerHTML = safeSpinner + '<span role="status" aria-live="polite" style="font-weight:500;">' + msg + '</span>';
        }
