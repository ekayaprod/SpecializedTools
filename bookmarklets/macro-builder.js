    ...
    class MacroBuilder {
        ...
        render() {
            this.s.innerHTML =
                ...
                'button{width:100%;background:#4f46e5;color:#fff;border:none;padding:10px;border-radius:6px;cursor:pointer;font-weight:600;margin-top:8px;transition:transform 0.2s, background-color 0.2s}' +
