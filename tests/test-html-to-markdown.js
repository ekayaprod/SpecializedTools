...
const h2mPath = path.join(__dirname, '../bookmarklets/html-to-markdown.js');
const h2mCode = fs.readFileSync(h2mPath, 'utf8');
...
// Execute html-to-markdown.js
try {
    eval(h2mCode);
} catch (e) {
    console.error('Error evaluating html-to-markdown.js:', e);
    process.exit(1);
}
