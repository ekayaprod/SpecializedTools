...
async function testLoadLibraryResilience() {
    ...
    // Test 1: Retry Logic - Success after 2 attempts
    {
        ...
        global.document.createElement = (tag) => {
            return {
                ...
                triggerError: function() { if(this._onerror) this._onerror(); },
                triggerLoad: function() { if(this._onload) this._onload(); }
            };
        };
     ...
     // Test 3: Existing Library (No load)
    {
        ...
        let attempts = 0;
        global.document.head.appendChild = (el) => { attempts++; return el; };
